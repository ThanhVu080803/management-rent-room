            ...
            <>
                <div className="intro intro-carousel swiper position-relative">
                    <Swiper spaceBetween={30}
                                                ...
                                                <div className="col-lg-8">
                                                    <div className="intro-body">
                                                        ...
                                                        <h1 className="intro-title mb-4 ">
                                                            <span className="color-b">Hồ Chí Minh </span> Một
                                                            <br /> Nơi tuyệt vời
                                                        </h1>
                        ...
                        <SwiperSlide className="carousel-item-b swiper-slide" >
                            <div className="swiper-slide carousel-item-a intro-item bg-image" style={{ backgroundImage: `url(assets/img/slide-about-1.jpg)` }}>
                                <div className="overlay overlay-a"></div>
                                <div className="intro-content display-table">
                                    <div className="table-cell">
                                        <div className="container">
